...
$('#title').text(i18n('RocketMap - Statistics'))
$('#options').text(i18n('Options'))
$('#header_duration').text(i18n('Duration'))
$('#last_hour').text(i18n('Last Hour'))
$('#last_3hours').text(i18n('Last') + ' 3 ' + i18n('Hours'))
$('#last_6hours').text(i18n('Last') + ' 6 ' + i18n('Hours'))
$('#last_12hours').text(i18n('Last') + ' 12 ' + i18n('Hours'))
$('#last_day').text(i18n('Last Day'))
$('#last_7days').text(i18n('Last') + ' 7 ' + i18n('Days'))
$('#last_14days').text(i18n('Last') + ' 14 ' + i18n('Days'))
$('#last_month').text(i18n('Last Month'))
$('#last_3month').text(i18n('Last') + ' 3 ' + i18n('Months'))
$('#last_6month').text(i18n('Last') + ' 6 ' + i18n('Months'))
$('#last_year').text(i18n('Last Year'))
$('#map_lifetime').text(i18n('Map Lifetime'))
...
function updateStats() {
    ...
    loadRawData().done(function (result) {
        ...
        $('#name').html(header)
        $('#message').html(i18n('Total') + ': ' + result.seen.total.toLocaleString())
        $('#td_pokedex').html(i18n('Pokédex'))
        $('#td_name').html(i18n('Name'))
        $('#td_seen').html(i18n('Seen'))
        $('#td_seen_percent').html(i18n('Seen') + '(%)')
        $('#td_last_seen').html(i18n('Last Seen'))
        $('#td_location').html(i18n('Location'))
        $('#td_heatmap').html(i18n('Heatmap'))
        $('#stats_table')
            .DataTable({
                paging: false,
                searching: false,
